...
public final class Constants {
  ...
  public static final class FuelConstants {
    ...
    public static final int LEFT_INTAKE_LAUNCHER_MOTOR_ID = 8;
    public static final int RIGHT_INTAKE_LAUNCHER_MOTOR_ID = 7;
    ...
    public static final double INDEXER_INTAKING_PERCENT = -.8/2; 
    public static final double INDEXER_LAUNCHING_PERCENT = 0.6/2;
    public static final double INDEXER_SPIN_UP_PRE_LAUNCH_PERCENT = -0.5/2;

    public static final double INTAKE_INTAKING_PERCENT = 0.6/2;
    public static final double LAUNCHING_LAUNCHER_PERCENT = .85/2;
    public static final double INTAKE_EJECT_PERCENT = -0.8/2;
